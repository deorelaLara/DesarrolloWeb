...
<body>
    ...
    <form name="id_form" id="id_form" action="#" method="post" accept-charset="utf-8" onsubmit="return valida_form();">
        ...
        <br><br>
        <label>Product: </label>
            <br><input type="radio" id="i_prod" name="i_prod" checked><label>Adobe ColdFusion Builder</label>
        ...
        <select name="s_enquiry" id="s_enquiry">
          ...
          <br><br>
          <textarea name="t_Enquiry" id="t_Enquiry" rows="5" cols="40" minlength="10" maxlength="100" placeholder="Tell us about your enquiry" required></textarea>
